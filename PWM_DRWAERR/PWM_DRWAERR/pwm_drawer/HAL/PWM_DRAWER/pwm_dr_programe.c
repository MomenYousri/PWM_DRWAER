...
void PWM_DRAWER_voidStart(){
	...
	LCD_voidDisplayString("-----HELLO IN------");
	...
	LCD_voidDisplayString("-------AMIT_D73-----");
	...
	LCD_voidGoToSpecificPosition(1,0);
	LCD_voidDisplayString("--PWM_DRAWER_PROJECT--");
	
	LCD_voidDisplayString("BY: MOMEN YOUSRI ");
	_delay_ms(4000);
	LCD_voidClear();
